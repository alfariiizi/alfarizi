...
Jawabannya adalah **Tidak**. Mengapa? Menurut saya neovim masih terlalu kompleks, banyak yang perlu dipahami, banyak yang perlu dibaca, dan banyak yang perlu disesuaikan. Kekurangan yang saya sebutkan diatas tidak terjadi di vscode. Ketika saya membuka vscode, saya bisa lebih terfokus pada task yang ada, dan tidak sering membuka file konfigurasi vscode nya. Selain itu, vscode hanya menggunakan json untuk mengatur konfigurasi nya, sehingga sangatlah mudah untuk mengatur konfigurasi nya.
